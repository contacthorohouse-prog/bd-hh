...
export declare class CommunityController {
    ...
    getAuthorProfile(userId: string): Promise<{
        user: import("mongoose").FlattenMaps<import("../users/schemas/user.schema").User & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
            _id: import("mongoose").Types.ObjectId;
        }> & {
            __v: number;
        }>;
